...
int BoundingSurface::GetSurface(vtkUnstructuredGrid* continuous_input, vtkUnstructuredGrid* output)
{
  ...
  mergePoints->InitPointInsertion(outpoints, continuous_input->GetBounds());
