...
INLET = pm.Options.Inlet(surface_ids=[1], insertion_rate=0.0e3,
...
MAPPING = lambda pos, vel: (numpy.array((0.0, pos[1], 0.0)), vel)
BOUNDARY = pm.IO.BoundaryData(BOUNDARY_MESH, inlets=[INLET], mapped_ids={2:MAPPING})
